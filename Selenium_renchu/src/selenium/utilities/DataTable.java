 ...
 * 
 */
public class DataTable extends RenchuTool
{
	...
	public DataTable() throws Exception
	{
		...
		System.out.println("Debug:xpath In XML:  "+xpath.toString());
		...
		for(OdfTable table:tableList)
		{
			...
			pop("sheetList["+tableCounter+"]="+sheetList[tableCounter]);
