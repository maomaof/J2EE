...
public class WebDriverCommands { 
	...
	{	
		...
		{
			Boolean vis = wait.until(ExpectedConditions.textToBePresentInElement(By.tagName("body"), ActionParameter));
			if(vis == false)
			{
				throw new AssertionError("Element "+UiLocator+ActionParameter+" not found");
			}
	...
	/*void uncheck(String UiLocator) throws Exception {
	    element = driver.findElement(findBy(UiLocator));
		if (element.isSelected()) {
	      element.click();
	    }
	}
	void check(String UiLocator) throws Exception {
	    element = driver.findElement(findBy(UiLocator));
		if (!element.isSelected()) {
	      element.click();
	    }
