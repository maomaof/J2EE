...
public class ParseXMLFile 
{
   ...
   private String[] testCaseIdsStr=null;   
   	 ...
   	 * @param fileLocation=relative path of fileLocation
   	 * Initialization: xmlDoc,testCaseIdsStr
   	 */
	...
	public String getTestStepDescription(String testCaseId,String testStepNo)
	   {
		   ...
		   try 
		   {
			    ...
			    JDOMXPath XPathTestStepDescription=new JDOMXPath("//TCID[@id='"+testCaseId+"']/Step[@no='"+testStepNo+"']/Description");				
	...
	public String getTestStepUILocator(String testCaseId,String testStepNo)
	   {
		   ...
		   try 
		   {
			    ...
			    JDOMXPath XPathTestStepUiLocator=new JDOMXPath("//TCID[@id='"+testCaseId+"']/Step[@no='"+testStepNo+"']/UILocator");				
	...
	public String getTestStepAction(String testCaseId,String testStepNo)
	   {
		   ...
		   try 
		   {
			    ...
			    JDOMXPath XPathTestStepAction=new JDOMXPath("//TCID[@id='"+testCaseId+"']/Step[@no='"+testStepNo+"']/Action");				
	...
	public String getTestStepActionParameter(String testCaseId,String testStepNo)
	   {
		   ...
		   try 
		   {
			    ...
			    JDOMXPath XPathTestStepActionParameter=new JDOMXPath("//TCID[@id='"+testCaseId+"']/Step[@no='"+testStepNo+"']/ActionParameter");				
